...
export default class getData{
    ...
    static getPhoneId(count:number,ids:string[]):Phone[]{ //Ф-ция возвращает необходимое количество телефонов с конкертными id, если id меньше чем необходимое количество, то берутся еще не выбранные модели
